...
neuron = Sources2D(); 
nams = {'msCam1.avi', 'msCam2.avi', 'msCam3.avi'};          % you can put all file names into a cell array; when it's empty, manually select files 
...
avi_filename = neuron.show_demixed_patch_vid(save_demixed, kt);
