...
%% choose data
neuron = Sources2D();
% nam = get_fullname('');          % this demo data is very small, here we just use it as an example
nam = [];
...
% range_ac = 5;
multi_factor = 10;
range_Y = 0 +[0, amp_ac*multi_factor];
% range_Y = 0+[0, 5000];

% avi_filename = neuron.show_demixed_video(save_demixed, kt, [], amp_ac, range_ac, range_Y, multi_factor);
% avi_filename = neuron.show_demixed_patch_vid(save_demixed, kt, [], amp_ac, range_ac, range_Y, multi_factor);
avi_filename = neuron.show_demixed(save_demixed, kt, [], amp_ac, range_ac, range_Y, multi_factor);
